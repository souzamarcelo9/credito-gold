...
export const createLeadSchema = z.object({
  ...
  produto:       z.enum(["pessoal", "garantia", "empresarial", "consignado", "fgts", "energia"]),
  valor:         z.number().positive("Valor deve ser positivo"),
  parcelas:      z.number().int().nonnegative().optional().default(0),
  parcelaMensal: z.number().nonnegative().optional().default(0),
